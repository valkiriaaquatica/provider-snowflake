...
type AuthenticationIntegrationWithClientCredentialsInitParameters struct {
...
type AuthenticationIntegrationWithClientCredentialsObservation struct {
...
type AuthenticationIntegrationWithClientCredentialsParameters struct {
...
// AuthenticationIntegrationWithClientCredentialsSpec defines the desired state of AuthenticationIntegrationWithClientCredentials
type AuthenticationIntegrationWithClientCredentialsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AuthenticationIntegrationWithClientCredentialsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AuthenticationIntegrationWithClientCredentialsInitParameters `json:"initProvider,omitempty"`
}

// AuthenticationIntegrationWithClientCredentialsStatus defines the observed state of AuthenticationIntegrationWithClientCredentials.
type AuthenticationIntegrationWithClientCredentialsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AuthenticationIntegrationWithClientCredentialsObservation `json:"atProvider,omitempty"`
}
...
// AuthenticationIntegrationWithClientCredentials is the Schema for the AuthenticationIntegrationWithClientCredentialss API. Resource used to manage api authentication security integration objects with client credentials. For more information, check security integrations documentation https://docs.snowflake.com/en/sql-reference/sql/create-security-integration-api-auth.
...
type AuthenticationIntegrationWithClientCredentials struct {
	...
	Spec   AuthenticationIntegrationWithClientCredentialsSpec   `json:"spec"`
	Status AuthenticationIntegrationWithClientCredentialsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AuthenticationIntegrationWithClientCredentialsList contains a list of AuthenticationIntegrationWithClientCredentialss
type AuthenticationIntegrationWithClientCredentialsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AuthenticationIntegrationWithClientCredentials `json:"items"`
}

// Repository type metadata.
var (
	AuthenticationIntegrationWithClientCredentials_Kind             = "AuthenticationIntegrationWithClientCredentials"
	AuthenticationIntegrationWithClientCredentials_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AuthenticationIntegrationWithClientCredentials_Kind}.String()
	AuthenticationIntegrationWithClientCredentials_KindAPIVersion   = AuthenticationIntegrationWithClientCredentials_Kind + "." + CRDGroupVersion.String()
	AuthenticationIntegrationWithClientCredentials_GroupVersionKind = CRDGroupVersion.WithKind(AuthenticationIntegrationWithClientCredentials_Kind)
)

func init() {
	SchemeBuilder.Register(&AuthenticationIntegrationWithClientCredentials{}, &AuthenticationIntegrationWithClientCredentialsList{})
}
